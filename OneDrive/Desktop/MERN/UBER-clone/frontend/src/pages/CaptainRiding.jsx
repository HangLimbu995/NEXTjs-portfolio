    ...
    return (
        <div className='h-screen'>
            <div className='fixed w-full top-0 p-3 flex justify-between items-center'>
                <Link to={'/captain-home'}> <img className='w-16' src='https://upload.wikimedia.org/wikipedia/commons/c/cc/Uber_logo_2018.png' alt='Uber' /></Link>
            ...
            <div ref={finishRidePanelRef} className='fixed w-full  px-2 py-6 pt-8 z-10 bottom-0 bg-white translate-y-full'>
