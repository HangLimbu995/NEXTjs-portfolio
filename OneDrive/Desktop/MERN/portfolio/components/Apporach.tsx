    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        ...
        <Card
          ...
          description="ONce we agree on teh plan, I cue my lofi playlist and dive into coding. From initial sketches to polished code, I keep you update every step of the way."
        >
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card
          ...
          description="This is where the magic happens! Based on the approved design, I'll translate everything into functional code, building your website from teh group up."
        >
          <CanvasRevealEffect
            animationSpeed={3}
