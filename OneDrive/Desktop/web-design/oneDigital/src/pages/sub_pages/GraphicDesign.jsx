          ...
          <div className='bg-gradient-to-r from-pink-500 to-purple-600 rounded-3xl shadow-lg p-8 md:p-12'>
            <div className='max-w-4xl mx-auto text-center'>
              ...
              <p className='text-lg md:text-xl text-pink-100 leading-relaxed'>
                At WEBSTARK, we bring your ideas to life through our expert graphic design services. Our talented team of designers combines creativity and technical skill to create visually compelling designs that captivate your audience and elevate your brand.
              </p>
            </div>
          </div>
        </div>
